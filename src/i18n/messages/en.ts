...
export const en = {
  ...
  analytics: {
    ...
    choroplethTitle: "Territorial map by indicator",
    choroplethHint: "Departments shaded by their value vs the national average (100%). Pick an indicator; hover a department for the detail.",
    choroplethMetric: "Indicator",
    vsNational: "vs national average",
    noSample: "No wells in the sample",
    ...
    rawSubtitle: "National and selected-entity values, with the relative variation.",
    rawMetricCol: "Indicator",
    rawSelectHint: "Select an entity to compare and see the variation.",
    rawEmptyTheme: "No data for this theme in the pilot inventory.",
